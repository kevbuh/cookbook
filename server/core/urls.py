...
from recipes.views import RecipeViewSet, SearchResultsList, RatingViewSet, LikeRecipeViewSet, CommentViewSet, UploadedImageViewSet
...
router.register(r'upload', UploadedImageViewSet, basename='Image')
